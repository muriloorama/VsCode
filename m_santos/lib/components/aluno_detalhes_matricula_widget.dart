  ...
  Widget build(BuildContext context) {
    return Align(
      ...
      child: Padding(
        ...
        child: FutureBuilder<List<MatriculasRow>>(
          future: MatriculasTable().querySingleRow(
            queryFn: (q) => q.eq(
              'id',
              widget.matriculaID,
            ),
          ...
          builder: (context, snapshot) {
            ...
            List<MatriculasRow> containerMatriculasRowList = snapshot.data!;
            final containerMatriculasRow = containerMatriculasRowList.isNotEmpty
                ? containerMatriculasRowList.first
                : null;
            return Container(
              width: 400.0,
              height: 400.0,
